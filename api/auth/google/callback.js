...
async function UpsertUser(Provider, ProviderId, Username, Email, AvatarUrl, Db) {
  ...
  const Ins = await Db.execute({
    sql: "INSERT INTO users (provider, provider_id, username, email, avatar_url, accent_color, text_color, background_color, icon_color, bg_effect_color, primary_color, secondary_color) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
